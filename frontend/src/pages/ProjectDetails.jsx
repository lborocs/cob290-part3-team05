    ...
    const fetchProjectDetails = async () => {
      try {
        ...
        const analyticsResponse = await fetch(
          `/api/project/${projectId}/analytics`,
          {
            method: "GET",
            headers: headers,
          }
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-screen">
        <div className="text-[#5A2777] text-xl">
      ...
      <div className="bg-white shadow-lg rounded-lg overflow-hidden border border-[#D9D9D9] mb-6">
        <div className="p-6 border-b border-[#D9D9D9] bg-gradient-to-r from-[#E8C2F4]/30 to-white">
          <div className="flex flex-wrap justify-between items-center">
            ...
            <span
              className={`px-4 py-2 inline-flex text-sm font-semibold rounded-full ${statusColor}`}
            >
              {status}
            </span>
          </div>
        ...
        <div className="p-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          <div className="bg-[#E8C2F4]/10 p-4 rounded-lg shadow-sm">
            ...
            <div className="text-2xl font-bold text-[#1C2341]">
              {metrics.daysToDeadline > 0
                ? `${metrics.daysToDeadline} days left`
                : "Overdue"}
            </div>
          ...
          <div className="bg-[#E8C2F4]/10 p-4 rounded-lg shadow-sm">
            ...
            <div className="text-2xl font-bold text-[#1C2341]">
              {metrics.taskPerUser.length}
            </div>
            <div className="text-[#2E3944] text-sm mt-1">total members</div>
          </div>
