                ...
                msg.senderUserID === 0 ? (
                    ...
                    >
                        ...
                        {editingMessageID === msg.messageID ? (
                            ...
                            <div
                                className={`flex flex-col max-w-[75%] ${msg.senderUserID === currentUserID ? "items-end" : "items-start"
                                    }`}
                            >
                                {/* Name and Time */}
                                ...
                                <div
                                    className={`relative w-full flex ${msg.senderUserID === currentUserID ? "justify-end" : "justify-start"
                                        } group`}
                                >
                                    {!msg.isDeleted && (
                                        <div
                      ...
                      `}
                                    ...
                                    {/* Message Bubble */}
                                    <div
                                        className={`p-3 rounded-2xl text-sm shadow-md max-w-[100%] break-words ${msg.senderUserID === currentUserID
